...
# engine = create_engine(f'postgresql://postgres:{password}@localhost:5432/Landings')
# conn = engine.connect()
#  # reflect an existing database into a new model
# Base = automap_base()
# # reflect the tables
# Base.prepare(engine, reflect=True)
# Meteorites = Base.classes.landings
# app = Flask(__name__)
# #################################################
# # Flask Routes
# #################################################
...
# def map():
#     session = Session(engine)
#     meteoritedata = session.query(Meteorites.name,Meteorites.mass,Meteorites.latitude,Meteorites.longitude).all()
#     session.close()
#     print(meteoritedata)
...
#     # Query for the dates and precipitation from last year
#     latitude = session.query(Meteorites.latitude).all()
#     session.close()
...
#     # Query for the dates and precipitation from last year
#     longitude = session.query(Meteorites.longitude).all()
#     session.close()
...
#     # Query for the dates and precipitation from last year
#     mass = session.query(Meteorites.mass).all()
#     session.close()
#     return jsonify(mass)
